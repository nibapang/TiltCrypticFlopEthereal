...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        background.setScale(aspectFillScale)
...
//        strategist = GKMinmaxStrategist()
        ...
        label.fontName = "STIX Two Text SemiBold"
        ...
        newLabel.fontColor = SKColor.black
        newLabel.fontName = "STIX Two Text SemiBold"
        ...
        whiteLabel.fontName = "STIX Two Text SemiBold"
        ...
        blackLabel.fontName = "STIX Two Text SemiBold"
        ...
        for i in 0..<64 {
            ...
            square.fillColor = gray ? .white : .black
